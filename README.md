...
| [Hashnode Article: Assign a smart contract to an existing SFS NFT with Thirdweb deployment](https://hashnode.com/post/clrth4j0t000608jr3v0dh2uo) | Technical Article on How to assign a contract an exsisting SFS NFT with Thirdweb | This artiicle covers how to assign a smart contract to an exsisting SFS NFT and deploy with thirdweb | Olayinka Oshidipe | 29.03.2024 |
| [Register a Smart Contract to SFS using thirdweb walkthrough video](https://drive.google.com/file/d/1kGpm22yY74ZgQ2O40qMliFOvd_Lxi4ZQ/view) | Video walk through on how to register a smart contract to SFS via Thirdweb | In this video, I go over how to register a smart contract to SFS via thirdweb | Olayinka Oshidipe | 29.03.2024 |
| [Assign a smart contract to an existing SFS NFT with Foundry video walkthrough](https://drive.google.com/file/d/1dmYsT4cIPVHgXciPD2hF-7yR_8OD_vzx/view) | A Video walk through on how to assign a smart contract to SFS via Foundry. | This video shows how to assign a smart contract to an existing SFS NFT using Foundry.  | Olayinka Oshidipe | 29.03.2024 |
